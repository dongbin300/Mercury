...
namespace Mercury.Backtests.BacktestStrategies
{
	...
	public class CGTrend1(string reportFileName, decimal startMoney, int leverage, MaxActiveDealsType maxActiveDealsType, int maxActiveDeals) : Backtester(reportFileName, startMoney, leverage, maxActiveDealsType, maxActiveDeals)
	{
		...
		public double RsiL = 40;
		public double RsiH = 60;
		public double RsiL2 = 60;
		public double RsiH2 = 40;

		public double RRange = 5;
		...
		protected override void LongEntry(string symbol, List<ChartInfo> charts, int i)
		{
			...
			if (trend > 0 && c1.Rsi1 < r.NextDouble(RsiL - RRange, RsiL + RRange))
			{
		...
		protected override void ShortEntry(string symbol, List<ChartInfo> charts, int i)
		{
			...
			if (trend < 0 && c1.Rsi1 > r.NextDouble(RsiH - RRange, RsiH + RRange))
			{
		...
		protected override void LongExit(string symbol, List<ChartInfo> charts, int i, Position longPosition)
		{
			...
			if (c1.Rsi1 > r.NextDouble(RsiL2 - RRange, RsiL2 + RRange))
			{
		...
		protected override void ShortExit(string symbol, List<ChartInfo> charts, int i, Position shortPosition)
		{
			...
			var c1 = charts[i - 1];
			var c2 = charts[i - 2];
			if (c1.Rsi1 < r.NextDouble(RsiH2 - RRange, RsiH2 + RRange))
			{
