...
{
	/// <summary>
	/// Cci21 - Corrected Cci9 Strategy
	/// 
	/// Cci9의 오류 수정 버전
	/// c0 조건식 사용 금지 - 완성된 캔들만 사용
	/// 진입: 올바른 2캔들 CCI 극값 반전
	/// 청산: 제로라인
	/// 
	/// </summary>
	public class Cci21(string reportFileName, decimal startMoney, int leverage, MaxActiveDealsType maxActiveDealsType, int maxActiveDeals) : Backtester(reportFileName, startMoney, leverage, maxActiveDealsType, maxActiveDeals)
	{
