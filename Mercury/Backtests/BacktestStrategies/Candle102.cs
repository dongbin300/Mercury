...
namespace Mercury.Backtests.BacktestStrategies
{
	...
	public class Candle102(string reportFileName, decimal startMoney, int leverage, MaxActiveDealsType maxActiveDealsType, int maxActiveDeals) : Backtester(reportFileName, startMoney, leverage, maxActiveDealsType, maxActiveDeals)
	{
		...
		protected override void LongEntry(string symbol, List<ChartInfo> charts, int i)
		{
			...
			if (
				...
				&& c8.CandlestickType == CandlestickType.Bearish
				)
			{
		...
		protected override void ShortEntry(string symbol, List<ChartInfo> charts, int i)
		{
			...
			if (
				...
				&& c8.CandlestickType == CandlestickType.Bullish
				)
			{
